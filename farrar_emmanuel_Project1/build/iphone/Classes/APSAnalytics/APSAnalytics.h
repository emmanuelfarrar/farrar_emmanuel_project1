 ...
 * to send analytic data that can be viewed on the farrar_emmanuel_Project1 Dashboard.
 *
 * For information on getting started with farrar_emmanuel_Project1 Platform Services,
