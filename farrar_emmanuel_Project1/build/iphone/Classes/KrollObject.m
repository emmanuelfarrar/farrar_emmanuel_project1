...
//@interface farrar_emmanuel_Project1Object : NSObject
//@end

@interface farrar_emmanuel_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[farrar_emmanuel_Project1Object class]])
		{
			for (NSString *key in [[(farrar_emmanuel_Project1Object*)o modules] allKeys])
			{
