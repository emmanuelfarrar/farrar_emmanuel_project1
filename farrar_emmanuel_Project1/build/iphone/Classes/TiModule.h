...
/**
 The base class for all farrar_emmanuel_Project1 modules
 */
...
/**
 farrar_emmanuel_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 farrar_emmanuel_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 farrar_emmanuel_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 farrar_emmanuel_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 farrar_emmanuel_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
