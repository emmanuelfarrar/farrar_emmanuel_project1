...
@interface farrar_emmanuel_Project1Object : KrollCoverageObject {
#else
@interface farrar_emmanuel_Project1Object : KrollObject {
#endif
@private
...
extern NSString * farrar_emmanuel_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	farrar_emmanuel_Project1Object *_farrar_emmanuel_project1;
    KrollObject* console;
	BOOL shutdown;
