...
//Rare exceptions to indicate a bug in the _farrar_emmanuel_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for farrar_emmanuel_Project1 proxies.
 */
