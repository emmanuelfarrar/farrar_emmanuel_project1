...
// in simulator we redefine to format for farrar_emmanuel_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.farrar_emmanuel_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.farrar_emmanuel_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIfarrar_emmanuel_Project1NativeItemNone = -1, 
	UIfarrar_emmanuel_Project1NativeItemSpinner = -2,
	UIfarrar_emmanuel_Project1NativeItemProgressBar = -3,
	
	UIfarrar_emmanuel_Project1NativeItemSlider = -4,
	UIfarrar_emmanuel_Project1NativeItemSwitch = -5,
	UIfarrar_emmanuel_Project1NativeItemMultiButton = -6,
	UIfarrar_emmanuel_Project1NativeItemSegmented = -7,
	
	UIfarrar_emmanuel_Project1NativeItemTextView = -8,
	UIfarrar_emmanuel_Project1NativeItemTextField = -9,
	UIfarrar_emmanuel_Project1NativeItemSearchBar = -10,
	
	UIfarrar_emmanuel_Project1NativeItemPicker = -11,
	UIfarrar_emmanuel_Project1NativeItemDatePicker = -12,
	
	UIfarrar_emmanuel_Project1NativeItemInfoLight = -13,
	UIfarrar_emmanuel_Project1NativeItemInfoDark = -14,
	
	UIfarrar_emmanuel_Project1NativeItemDisclosure = -15,
	
	UIfarrar_emmanuel_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all farrar_emmanuel_Project1 instances of
